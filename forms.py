...
class CharacterForm(Form):
    ...
    str = StringField('STR', validators=[DataRequired(),
                                       Regexp(
                                           r'^[0-9]+$',
                                           message=("Numbers Only")
                                       )])
    int = StringField('INT', validators=[DataRequired(),
                                       Regexp(
                                           r'^[0-9]+$',
                                           message=("Numbers Only")
                                       )])
    dex = StringField('DEX', validators=[DataRequired(),
                                       Regexp(
                                           r'^[0-9]+$',
                                           message=("Numbers Only")
                                       )])
    con = StringField('CON', validators=[DataRequired(),
                                       Regexp(
                                           r'^[0-9]+$',
                                           message=("Numbers Only")
                                       )])
    wis = StringField('WIS', validators=[DataRequired(),
                                       Regexp(
                                           r'^[0-9]+$',
                                           message=("Numbers Only")
                                       )])
    cha = StringField('CHA', validators=[DataRequired(),
                                       Regexp(
                                           r'^[0-9]+$',
                                           message=("Numbers Only")
                                       )])
